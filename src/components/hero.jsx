...
export const Hero = () => {
  return (
    <div className="relative sm:h-[80vh] h-[40vh] w-full overflow-hidden bg-[url('/hero.jpeg')] bg-contain bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center px-4 ">
