    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <Link
            to="/"
            className="flex items-center gap-1 text-[#111827] text-2xl font-extrabold tracking-tight"
          >
            <img src="/logo.png" alt="Jynetra logo" className="h-8 w-auto" />
      ...
      <div
        className={`fixed inset-0 bg-[#111827]/40 backdrop-blur-sm z-[100] transition-opacity duration-300 ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"
          }`}
      ...
      {/* Sidebar Menu */}
      <div
        className={`fixed top-0 right-0 h-full w-[280px] bg-white z-[101] shadow-2xl p-8 transform transition-transform duration-500 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
